...
import { ExecutableCondition } from "../../../../../../digital-form-builder/runner/src/server/plugins/engine/models/types";
import { DEFAULT_FEE_OPTIONS } from "../../../../../../digital-form-builder/runner/src/server/plugins/engine/models/FormModel.feeOptions";
import { ContextComponentCollection } from "../../../../../../digital-form-builder/runner/src/server/plugins/engine/components/ContextComponentCollection";
...
export class FormModel {
  ...
  constructor(def, options) {
    ...
    console.log("Inside the customized FormModel")
    if (result.error) {
      throw result.error;
    }

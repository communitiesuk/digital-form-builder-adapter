...
class MockPreAwardApiClient {
  ...
  async createOrUpdateForm(name: string, formData: any): Promise<any> {
...
suite("PreAwardApiClient", () => {
  ...
  beforeEach(() => {
    ...
    client = new MockPreAwardApiClient("http://test-api.com", wreckStub);
  });
  ...
  suite("createOrUpdateForm", () => {
    test("should successfully create a new form", async () => {
      ...
      const result = await client.createOrUpdateForm("new-form-id", formData);
    ...
    test("should handle network errors", async () => {
      ...
      try {
        await client.createOrUpdateForm("test-id", {});
